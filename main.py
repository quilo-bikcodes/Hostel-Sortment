...
file_obj = drive.CreateFile({'id': '12vtkiUGj-DKpGX4_2GG4BC7cA3auqwIL_56GGA8gO5s'})
file_obj.GetContentFile('Data Collect (Responses).xls',
         mimetype='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')
  
dataframe = pd.read_excel('Data Collect (Responses).xls')
print(dataframe)

# 12vtkiUGj-DKpGX4_2GG4BC7cA3auqwIL_56GGA8gO5s