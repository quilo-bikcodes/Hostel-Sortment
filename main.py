...
neighbors_dict_1 = collections.defaultdict(list)
                ...
                if str(room) in rooms_names_1:
                    ...
                    if len(room_dict_1[str(room)])==0:
                                ...
                                for i in range(-10,11):
                                    ...
                                    if 'G-' in str(room):
                                        neighbour = str(int(str(room).replace('G-',"")) + i) 
                                        if neighbour.replace("",'G-') in rooms_names_1:
                                            df3 = df2.loc[df2['Room No. '].astype(str) == neighbour]
                                            # print(df3)
                                        
                                        
                                    else:
                                        neighbour = f'{int(str(room)) + i}'   
                                                                             # print(neighbour)
                                        if str(neighbour) != str(room):
            ...
            if len(room_dict_1[roomno][0]) > 1:
                ...
                for i2 in range(len(room_dict_1)):
                    try:
                        ...
                        l = room_dict_1[roomno][3][i2]
                        m = room_dict_1[roomno][4][i2]
                ...
                # context = context + "\n\n\n" + f"These are the hostel mates of your block 1[COMMON BLOCK LIST]: \n"
